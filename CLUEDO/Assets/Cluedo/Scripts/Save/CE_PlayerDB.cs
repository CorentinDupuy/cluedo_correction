...
public struct CE_PlayerDB
{
    ...
    #endregion
    #region Public
    public CE_PlayerDB(Vector3 _position, bool _isInRoom, List<CE_Note> _notes, CE_HandCards _handCards, int _idNextRoom, int _idLastRoom, AIPhase _aiPhase, Vector3 _nextDoorPosition)
    {
